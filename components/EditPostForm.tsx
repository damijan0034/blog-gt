    ...
    <div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-2"> 
            ...
            <div className="flex gap-2">
                <input className="flex-1" placeholder='Paste the link and click on add'
            ...
            className={`h-48 border-2 mt-4 border-dotted
                grid place-items-center rounded-md relative
            ...
            >
                ...
                </div>
                {
                    imgUrl && (
                        ...
                        className="absolute object-cover inset"
                        />
                    )
                }
            </CldUploadButton >
            {
                publicId && (
                    <button onClick={removeImage} className="btn w-fit bg-red-400 text-white">
                        Delete image
                        </button>
                )
            }
